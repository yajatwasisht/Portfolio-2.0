...
export default function Footer() {
  ...
  return (
    <section
      id="footer"
      className="my-6 sm:my-8 text-sm sm:text-base lg:text-lg flex md:justify-between justify-center text-white"
    >
      <p>
        <span className="text-xl sm:text-2xl">&copy;</span> {curYear} . YAJAT WASISHT . ALL RIGHTS RESERVED
      </p>
      <Link
